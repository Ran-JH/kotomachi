...
const NOTE_COPY = {
  ...
  en: {
    eyebrow: "Street note",
    noteHint: "This note feels like it was left for someone who found this place.",
    title: "Saku / 朔（さく）",
    lines: [
      ...
      "No one seems to know how unsaid words end up with him.",
    ],
  },
} as const;
    ...
    >
      <div className="flex flex-col gap-2">
        <p className="text-[11px] text-[#7A7060]">
          <span className="font-medium tracking-[0.18em]">{copy.eyebrow}</span>
          <span className="px-1.5 text-[#B6AD9A]">·</span>
          <span className="text-[#8B816F]">{copy.noteHint}</span>
        </p>
