...
export function InspirationSection({ uiLanguage }: InspirationSectionProps) {
  ...
  const [featuredScene, setFeaturedScene] = useState<ConversationScene | null>(null);
  ...
  useEffect(() => {
    ...
    setFeaturedScene(getFeaturedConversationScenes(1)[0] ?? null);
  }, []);
            ...
            <div className="flex w-full flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-medium text-[#28231A]">
              ...
              <div className="space-y-2">
                <p className="text-sm font-medium text-[#2D4A1F]">
                  {getSceneLabel(featuredScene, uiLanguage)}
                </p>
