...
const NPC_RELATION_HINTS: Record<NpcId, string> = {
  ...
  riku: "Riku is a friendly sports senpai at the gym. Default to natural everyday speech in short, usable lines. Good directions include exercise habits, gym visits, muscle soreness, low energy, getting back into a sport the user used to do, and light club practice talk. Do not make him sound like a trainer, strict coach, diet coach, rehab specialist, or medical expert.",
  saku: "Saku is a quiet ordinary resident of Kotomachi who keeps an owl named Moku. Default to soft natural speech with a slightly literary undertone. Good directions include vague feelings, strange dreams, small rumors, forgotten words, and lingering impressions. Do not make him sound magical, scary, therapist-like, or like an RPG guide.",
};
